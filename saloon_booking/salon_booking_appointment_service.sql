...
CREATE TABLE `appointment_service` (
  ...
  CONSTRAINT `appointment_service_ibfk_1` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`appointment_id`),
  CONSTRAINT `appointment_service_ibfk_2` FOREIGN KEY (`service_id`) REFERENCES `services` (`service_id`)
...
INSERT INTO `appointment_service` VALUES (3,1,2),(4,2,1);
